/* nav-fragment.js v2 — SVG logos + nav + footer */
(function(){
    ...
    <ul class="nav-menu" id="nav-menu" role="list">
      ...
      <li class="nav-dropdown nav-item">
        ...
        <div class="dropdown-menu" role="menu">
          <a href="stage-febus.html" role="menuitem">
            <svg width="16" height="16" color="var(--accent)"><use href="#logo-febus"/></svg>
            FEBUS OPTICS
          </a>
          <a href="stage-argitik.html" role="menuitem">
      ...
      <li class="nav-dropdown nav-item">
        ...
        <div class="dropdown-menu" role="menu">
          <a href="atelier-picdumidi.html" role="menuitem">
            <svg width="16" height="16"><use href="#logo-pic"/></svg>
            PicDuMidiBoutique
          </a>
          <a href="atelier-integration.html" role="menuitem">
            <svg width="16" height="16" color="var(--accent)"><use href="#ic-layers"/></svg>
            Intégration
          </a>
          <a href="atelier-commande.html" role="menuitem">
            <svg width="16" height="16" color="var(--accent)"><use href="#ic-db"/></svg>
            Commande
          </a>
          <a href="atelier-fa.html" role="menuitem">
      ...
      <li class="nav-dropdown nav-item">
        ...
        <div class="dropdown-menu" role="menu">
          <a href="veille-cybersecurite.html" role="menuitem">
            <svg width="16" height="16"><use href="#logo-cyber"/></svg>
            Cybersécurité
          </a>
          <a href="veille-snyk.html" role="menuitem">
